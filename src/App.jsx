  ...
  return (
    <div className="flex flex-col md:min-h-screen mt-12 px-4">
      <div className='max-w-5xl md:max-w-full'>
        <div className='font-extrabold text-2xl md:text-4xl text-blue-600 mb-6 md:mb-5 text-center w-[1000px] mx-auto rounded-xl p-4 drop-shadow-xl' style={{ backgroundColor: 'white' }}>Markdown using own custom string manipulation</div>
